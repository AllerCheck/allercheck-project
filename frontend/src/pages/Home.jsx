  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-12 lg:px-24 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 min-h-screen">
          ...
          {pollenError ? (
            ...
            <div>
              {currentPollenData.map((day, index) => (
                <div key={index} className="mt-6 p-6 rounded-2xl hover:bg-white/10 transition-all duration-200">
                  <p className="text-lg text-gray-300">
                    <strong>Date:</strong> {day.date?.day}/{day.date?.month}/{day.date?.year}
                  </p>

                  {/* Pollen Types */}
                  <h4 className="font-semibold mt-4 text-yellow-300 text-xl">Pollen Types:</h4>
                        ...
                        {pollen.indexInfo && (
                          <>
                            ...
                            <div
                              ...
                              style={{
                                backgroundColor: `rgb(${pollen.indexInfo.color.green * 255}, 0, ${pollen.indexInfo.color.blue * 255})`,
                              }}
                            ></div>
                          </>
                        )}
                  ...
                  {/* Plants Information */}
                  <h4 className="font-semibold mt-4 text-yellow-300 text-xl">Plants:</h4>
                  <ul className="list-disc ml-6 text-gray-300">
                        ...
                        {plant.indexInfo && (
                          <>
                            ...
                            <div
                              className="w-10 h-10 rounded-full mt-2"
                              style={{
                                backgroundColor: `rgb(${plant.indexInfo.color.green * 255}, 0, ${plant.indexInfo.color.blue * 255})`,
                              }}
                            ></div>
                          </>
                        )}
      ...
      <div className="text-gray-300 text-lg text-center">
        <p>Coming Soon: Exclusive Offers & Ads</p>
      </div>
    </div>
  );
}
